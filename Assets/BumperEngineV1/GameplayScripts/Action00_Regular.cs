...
public class Action00_Regular : MonoBehaviour {
    ...
    void Update()
    {
        ...
        //Do Spindash
		if (Input.GetButton("B") && Player.Grounded && Player.GroundNormal.y > MaximumSlope && Player.p_rigidbody.velocity.sqrMagnitude < MaximumSpeed) { Actions.ChangeAction(3); Actions.Action03.InitialEvents(); }
